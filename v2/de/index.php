...
<div class="container vertical-center">
    <div class="hbbk-login form-group">
        <h4>Bitte melde dich mit deinen Ilias Anmeldedaten aus der Schule an:</h4>
        <form>
            <label id="nutzer">Nutzername: <input type="text" name="username" id="username" required autofocus autocomplete="on" class="form-control"></label>
            <label id="passwort">Passswort: <input type="password" name="password" id="password" required autocomplete="on" class="form-control"></label>
            <button class="btn-primary" id="send">Anmelden</button>
        </form>
    </div>
    <div class="hbbk-choose form-group">
        <form>

            <label id="klasse">
                <h4>Bitte wähle deine Klasse aus:</h4>
                <select name="class" id="class" autocomplete="on" class="form-control">
                    <?php
            ...
            <label id="woche">
                ...
                <select name="week" id="week" autocomplete="on" class="form-control">
            ...
            <br>
            <label>
                Vorlieben speichern? <input type="checkbox" class="form-control" id="save" name="save">
            </label>
            <br>
            <button class="btn-primary">Vertretungsplan anzeigen</button>
        </form>
    </div>
